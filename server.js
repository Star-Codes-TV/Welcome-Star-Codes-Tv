...
setInterval(() => {
  http.get(`http://welcomeme1010.glitch.me/`);
}, 280000);
...
const youtube = new YouTube('AIzaSyBuRHrwIp4CHZUNZHQjNdEytzW5cRBn4m4');
const hastebins = require('hastebin-gen');
const getYoutubeID = require('get-youtube-id');
const yt_api_key = "AIzaSyBuRHrwIp4CHZUNZHQjNdEytzW5cRBn4m4";
...
client.on("message", async message => {
  ...
  if (message.content.startsWith(prefix + "setLeave")) { /// تعديل اللغه
...
client.on("message", message => {
  ...
  if (msg.startsWith(prefix + "WEATHER")) { /// تعديل اللغه
    weather.find({ search: args.join(" "), degreeType: "F" }, function(
      ...
      const embed = new Discord.RichEmbed()
        .setDescription(`**${current.sk.jhytext}**`)
...
client.on("message", message => {
  ...
  if (message.content.startsWith(prefix + "setWelcomer")) { /// تعديل اللغه
...
client.on("message", message => {
  if (message.content.startsWith(prefix + "toggleLeave")) { /// تعديل اللغه
    if (!message.channel.guild)
      return message.reply("**This Command Only For Servers**");
    if (!message.member.hasPermission("MANAGE_GUILD"))
      return message.channel.send(
...
client.on("message", message => {
  if (message.content.startsWith(prefix + "toggleWelcome")) { /// تعديل اللغه
    if (!message.channel.guild)
      return message.reply("**This Command Only For Servers**");
    if (!message.member.hasPermission("MANAGE_GUILD"))
      return message.channel.send(
...
client.on("message", message => {
  if (message.content.startsWith(prefix + "toggleDmwelcome")) { /// تعديل اللغه
    if (!message.channel.guild)
      return message.reply("**This Command Only For Servers**");
    if (!message.member.hasPermission("MANAGE_GUILD"))
      return message.channel.send(
...
client.on("message", message => {
  if (message.content.startsWith(prefix + "toggleInvitedby")) { /// تعديل اللغه
    if (!message.channel.guild)
      return message.reply("**This Command Only For Servers**");
    if (!message.member.hasPermission("MANAGE_GUILD"))
      return message.channel.send(
